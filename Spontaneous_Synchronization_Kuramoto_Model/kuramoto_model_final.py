...
Collective Synchronization in the Kuramoto Model
------------------------------------------------
Author: Petros Agridos

Description:
This project numerically simulates the **Kuramoto model**, a fundamental framework 
in nonlinear dynamics that describes how synchronization emerges in large populations 
...
where:
    ...
    • ω_i: natural frequency drawn from a statistical distribution
    • K: global coupling strength

The simulation explores several aspects of collective synchronization:
    • Dependence of the global order parameter *r(T)* on coupling strength *K*
    • Time evolution of phase coherence *r(t)* for multiple coupling values
    • Statistical fluctuations from varying initial phases or frequency distributions
    • Transition from incoherence to synchronized phase as *K* increases

Features:
    • Modular functions for initialization, evolution, and plotting
    • Customizable frequency and phase distributions
    • Comparative simulations:
        - Fixed frequencies with varying initial conditions
        - Fixed phases with varying natural frequencies
    • Visualization of:
        - Coherence vs. coupling constant K
        - Time-dependent coherence for several K values

Dependencies:
    numpy, matplotlib

Outputs:
    • Plots of r(t) and r(K)
    • Visualization of synchronization transition
    • Insights into the role of coupling and heterogeneity in phase-locking
